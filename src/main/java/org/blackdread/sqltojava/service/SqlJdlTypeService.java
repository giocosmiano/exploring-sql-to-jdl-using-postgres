...
public class SqlJdlTypeService {
    ...
    protected List<String> jdlJson() {
        return Lists.newArrayList("json", "jsonb");
    }
    ...
    protected List<String> jdlString() {
        return Lists.newArrayList("varchar", "char", "text", "tinytext", "character", "character varying", "tsvector", "user-defined", "array");
    }
    ...
    protected List<String> jdlBlob() {
        return Lists.newArrayList("tinyblob", "blob", "mediumblob", "longblob", "bytea");
    }

    protected List<String> jdlInteger() {
        return Lists.newArrayList("smallint", "mediumint", "int", "integer");
    }
    ...
    protected List<String> jdlInstant() {
        return Lists.newArrayList("datetime", "timestamp", "timestamp without time zone");
    }
